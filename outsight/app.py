...
ap.add_argument("-d", "--debug", type=boolean, default=False, help="whether or not to show additional visualizations")
...
if __name__ == '__main__':
    ...
    if args["workflow"] == 'all':
        flow.run([Search, DisplayImageOCR, Anonymize], forced_all_upstream=True, confirm=False)  # multiple tasks,SearchDB,SaveAnonymImage
